...
public class Orders implements java.io.Serializable {
	...
	public String toString() {
		return "Orders [orderNumber=" + orderNumber + ", customers="
				+ customers + ", orderDate=" + orderDate + ", requiredDate="
				+ requiredDate + ", shippedDate=" + shippedDate + ", status="
				+ status + ", comments=" + comments + ", orderdetailses="
				+ orderdetailses + "]";
	}
