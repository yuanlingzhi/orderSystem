...
public class Customers implements java.io.Serializable {
	...
	public String toString() {
		return "Customers [customerNumber=" + customerNumber + ", employees="
				+ employees + ", customerName=" + customerName
				+ ", contactLastName=" + contactLastName
				+ ", contactFirstName=" + contactFirstName + ", phone=" + phone
				+ ", addressLine1=" + addressLine1 + ", addressLine2="
				+ addressLine2 + ", city=" + city + ", state=" + state
				+ ", postalCode=" + postalCode + ", country=" + country
				+ ", creditLimit=" + creditLimit + ", orderses=" + orderses
				+ ", paymentses=" + paymentses + "]";
	}
	...
	public Customers(int customerNumber, Employees employees,
			...
			String country, Double creditLimit, Set orderses, Set paymentses) {
		this.customerNumber = customerNumber;
